...
export class AuthController {
  ...
  async sendForgotPassword(
    @Body(
      new ValidationPipe({ whitelist: true, forbidNonWhitelisted: true, stopAtFirstError: true })) dto: ForgotPasswordDto) {
  ...
  async resetForgotPassword(
    @Body(
      new ValidationPipe({ whitelist: true, forbidNonWhitelisted: true, stopAtFirstError: true })) dto: ResetPasswordDto) {
